...
class TestPortfolioContent:
    ...
    def test_about_content_structure(self, client):
        ...
        content_indicators = [
            b'experience', b'skills', b'background', 
            b'developer', b'engineer', b'professional'
        ]
        
        found_indicators = sum(1 for indicator in content_indicators 
    ...
    def test_projects_display(self, client):
        ...
        project_indicators = [
            b'project', b'github', b'demo', b'technology', b'stack'
        ]
        
        found_indicators = sum(1 for indicator in project_indicators 
                             if indicator in response.data.lower())
        assert found_indicators > 0
    ...
    def test_skills_categories(self, client):
        ...
        skill_categories = [
            b'frontend', b'backend', b'database', b'framework',
            b'python', b'javascript', b'html', b'css'
        ]
        
        found_categories = sum(1 for category in skill_categories 
                             if category in response.data.lower())
    ...
    def test_testimonials_structure(self, client):
        ...
        testimonial_indicators = [
            b'testimonial', b'client', b'review', b'feedback'
        ]
        
        found_indicators = sum(1 for indicator in testimonial_indicators 
                             if indicator in response.data.lower())
        assert found_indicators > 0
...
class TestPortfolioNavigation:
    ...
    def test_back_to_home_links(self, client):
        ...
        found_indicators = sum(1 for indicator in home_indicators 
                             if indicator in response.data.lower())
        assert found_indicators > 0
...
class TestPortfolioSEO:
    ...
    def test_unique_page_titles(self, client):
        ...
        pages = ['/portfolio', '/portfolio/about', '/portfolio/projects', 
                '/portfolio/skills', '/portfolio/testimonials']
...
class TestPortfolioResponsive:
    ...
    def test_responsive_design(self, client, viewport):
        ...
        responsive_indicators = [
            b'responsive', b'viewport', b'mobile', b'bootstrap'
        ]
    ...
    def test_mobile_navigation(self, client):
        ...
        mobile_nav_indicators = [
            b'hamburger', b'toggle', b'menu', b'nav'
        ]
        found = sum(1 for indicator in mobile_nav_indicators 
                   if indicator in response.data.lower())
        assert found > 0
...
class TestPortfolioIntegration:
    ...
    def test_external_links(self, client):
        ...
        external_indicators = [
            b'github', b'linkedin', b'twitter', b'portfolio'
        ]
        
        # At least some external presence expected
        found = sum(1 for indicator in external_indicators 
                   if indicator in response.data.lower())
