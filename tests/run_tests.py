...
def run_coverage_analysis():
    ...
    try:
        ...
        subprocess.run(
            [sys.executable, "-m", "pip", "install", "coverage"], capture_output=True
        )

        # Run tests with coverage
        cmd = ["python", "-m", "coverage", "run", "-m", "pytest", "tests/", "--quiet"]
...
def run_performance_tests():
    ...
    cmd = ["python", "-m", "pytest", "-k", "performance", "-v", "--tb=short"]
...
def run_security_tests():
    ...
    cmd = ["python", "-m", "pytest", "-k", "security", "-v", "--tb=short"]
