...
class TestDeveloperAgent:
    ...
    def test_developer_agent_config(self):
        ...
        config_path = (
            "/workspaces/3in1-portfolio-webdev-aiservices/agents/developer/config.yaml"
        )
...
class TestContentCreatorAgent:
    ...
    def test_seo_optimization(self, mock_agent):
        ...
        agent = mock_agent()
        result = agent.optimize_for_seo(
            "How to Build a Website", "content about building websites"
        )
...
class TestPersonaAgents:
    ...
    def test_strict_wife_persona(self):
        ...
        config_path = (
            "/workspaces/3in1-portfolio-webdev-aiservices/agents/strictwife/config.yaml"
        )
    ...
    def test_lazy_john_persona(self):
        ...
        config_path = (
            "/workspaces/3in1-portfolio-webdev-aiservices/agents/lazyjohn/config.yaml"
        )
...
class TestCoderbotAgent:
    ...
    def test_coderbot_config(self):
        ...
        config_path = (
            "/workspaces/3in1-portfolio-webdev-aiservices/agents/coderbot/config.yaml"
        )
    ...
    def test_coderbot_advanced_coding(self, mock_agent):
        ...
        agent = mock_agent()
        result = agent.generate_complex_solution(
            "Build a web scraper for e-commerce sites"
        )
