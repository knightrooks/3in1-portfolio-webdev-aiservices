...
class StrictwifeController:
    ...
    def __init__(self):
        ...
        self.personality_traits = ['strict', 'organized', 'disciplinary', 'no_nonsense', 'goal_oriented', 'demanding_excellence']
        self.response_style = {'tone': 'authoritative_firm', 'formality': 'strict_formal', 'directness': 'very_direct', 'accountability': 'high'}
    ...
    def _get_fallback_response(self) -> str:
        ...
        return fallback_responses.get('Authoritative', "I didn't understand that. Could you please rephrase?")
