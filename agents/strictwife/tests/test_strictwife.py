...
class TestStrictwifeAgent(unittest.TestCase):
    """Test cases for Strict Wife agent"""
    
    def setUp(self):
        """Set up test fixtures"""
        self.controller = StrictwifeController()
        self.test_session_id = 'test_session'
    
    def test_controller_initialization(self):
        """Test controller initialization"""
        self.assertIsNotNone(self.controller)
        self.assertEqual(self.controller.personality_traits, ['strict', 'organized', 'disciplinary', 'no_nonsense', 'goal_oriented', 'demanding_excellence'])
        self.assertEqual(self.controller.response_style, {'tone': 'authoritative_firm', 'formality': 'strict_formal', 'directness': 'very_direct', 'accountability': 'high'})
    ...
    def test_personality_traits(self):
        ...
        personality_message = test_cases.get('Authoritative', "Hello")
    ...
    def test_context_building(self):
        ...
        self.assertEqual(context['agent_name'], 'Strict Wife')
        self.assertEqual(context['personality_type'], 'Authoritative')
