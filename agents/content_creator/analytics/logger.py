...
class ContentCreatorAnalyticsLogger:
    ...
    def setup_logger(self, log_level: str):
        ...
        general_handler = logging.FileHandler(
            f"{log_dir}/content_creator_activities.log"
        )
        consultation_handler = logging.FileHandler(
            f"{log_dir}/content_creator_consultations.log"
        )
    ...
    def log_business_impact(
        self, conversation_id: str, impact_category: str, impact_level: str = "medium"
    ):
