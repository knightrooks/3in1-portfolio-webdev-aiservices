"""
Operations Manager AI WebSocket Handler
...
class OperationsmanagerSocketHandler:
    """Production WebSocket handler for Operations_Manager agent"""
    ...
    def setup_handlers(self):
        ...
        @self.socketio.on("connect", namespace="/operations_manager")
        def handle_connect():
            ...
            try:
                ...
                active_sessions[client_id] = {
                    ...
                    "message_count": 0,
                    "room": f"operations_manager_{session_id}",
                    "authenticated": False,
                }
        ...
        @self.socketio.on("disconnect", namespace="/operations_manager")
        ...
        @self.socketio.on("message", namespace="/operations_manager")
        ...
        @self.socketio.on("ping", namespace="/operations_manager")
        def handle_ping():
