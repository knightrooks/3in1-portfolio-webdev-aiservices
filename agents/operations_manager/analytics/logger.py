"""
Operations Manager Agent Analytics Logger
Advanced logging for Operations optimization and process management activities.
"""
...
class OperationsManagerAnalyticsLogger:
    """Advanced analytics logger for Operations Manager agent."""
    
    def __init__(self, log_level: str = "INFO"):
        self.agent_name = "operations_manager"
        self.setup_logger(log_level)
        
    def setup_logger(self, log_level: str):
        """Setup specialized logging for operations manager activities."""
        # Create logs directory if it doesn't exist
        log_dir = "logs/agents/operations_manager"
        os.makedirs(log_dir, exist_ok=True)
        
        # Main operations_manager logger
        ...
        general_handler = logging.FileHandler(f"{log_dir}/operations_manager_activities.log")
        consultation_handler = logging.FileHandler(f"{log_dir}/operations_manager_consultations.log")
    ...
    def log_consultation_request(self, user_id: str, consultation_type: str, complexity: str = "moderate"):
        """Log a new operations manager consultation request."""
    ...
    def log_consultation_completion(self, conversation_id: str, total_duration: float,
        ...
        """Log operations manager consultation completion."""
        self.consultation_logger.info(
    ...
    def log_error(self, error_type: str, error_message: str, conversation_id: Optional[str] = None):
        """Log errors in operations manager consultation process."""
    ...
    def get_log_summary(self, hours: int = 24) -> Dict[str, Any]:
        ...
        try:
            log_file = f"logs/agents/operations_manager/operations_manager_activities.log"
            return {
                "agent_name": "operations_manager",
                "agent_type": "Operations optimization and process management",
                "period_hours": hours,
                "log_files_available": [
                    f"operations_manager_activities.log",
                    f"operations_manager_consultations.log", 
...
operations_manager_analytics_logger = OperationsManagerAnalyticsLogger()
