...
class OperationsManagerAnalyticsLogger:
    ...
    def setup_logger(self, log_level: str):
        ...
        general_handler = logging.FileHandler(
            f"{log_dir}/operations_manager_activities.log"
        )
        consultation_handler = logging.FileHandler(
            f"{log_dir}/operations_manager_consultations.log"
        )
    ...
    def get_log_summary(self, hours: int = 24) -> Dict[str, Any]:
        ...
        try:
            log_file = (
                f"logs/agents/operations_manager/operations_manager_activities.log"
            )
            return {
