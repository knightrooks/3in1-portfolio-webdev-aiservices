...
class SecurityExpertAnalyticsLogger:
    ...
    def setup_logger(self, log_level: str):
        ...
        general_handler = logging.FileHandler(
            f"{log_dir}/security_expert_activities.log"
        )
        consultation_handler = logging.FileHandler(
            f"{log_dir}/security_expert_consultations.log"
        )
    ...
    def log_business_impact(
        self, conversation_id: str, impact_category: str, impact_level: str = "critical"
    ):
