"""
Security Expert Agent Analytics Logger
Advanced logging for Cybersecurity and risk assessment activities.
"""
...
class SecurityExpertAnalyticsLogger:
    """Advanced analytics logger for Security Expert agent."""
    
    def __init__(self, log_level: str = "INFO"):
        self.agent_name = "security_expert"
        self.setup_logger(log_level)
        
    def setup_logger(self, log_level: str):
        """Setup specialized logging for security expert activities."""
        # Create logs directory if it doesn't exist
        log_dir = "logs/agents/security_expert"
        os.makedirs(log_dir, exist_ok=True)
        
        # Main security_expert logger
        ...
        general_handler = logging.FileHandler(f"{log_dir}/security_expert_activities.log")
        consultation_handler = logging.FileHandler(f"{log_dir}/security_expert_consultations.log")
    ...
    def log_consultation_request(self, user_id: str, consultation_type: str, complexity: str = "moderate"):
        """Log a new security expert consultation request."""
    ...
    def log_consultation_completion(self, conversation_id: str, total_duration: float,
        ...
        """Log security expert consultation completion."""
        self.consultation_logger.info(
    ...
    def log_error(self, error_type: str, error_message: str, conversation_id: Optional[str] = None):
        """Log errors in security expert consultation process."""
    ...
    def get_log_summary(self, hours: int = 24) -> Dict[str, Any]:
        ...
        try:
            log_file = f"logs/agents/security_expert/security_expert_activities.log"
            return {
                "agent_name": "security_expert",
                "agent_type": "Cybersecurity and risk assessment",
                "period_hours": hours,
                "log_files_available": [
                    f"security_expert_activities.log",
                    f"security_expert_consultations.log", 
...
security_expert_analytics_logger = SecurityExpertAnalyticsLogger()
