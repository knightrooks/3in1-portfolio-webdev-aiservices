...
class GirlfriendController:
    ...
    def __init__(self):
        ...
        self.personality_traits = ['affectionate', 'supportive', 'caring', 'understanding', 'romantic', 'empathetic']
        self.response_style = {'tone': 'warm_affectionate', 'formality': 'casual', 'empathy_level': 'high', 'humor': 'gentle'}
    ...
    def _get_fallback_response(self) -> str:
        ...
        return fallback_responses.get('Romantic', "I didn't understand that. Could you please rephrase?")
