...
class GossipqueenController:
    ...
    def __init__(self):
        ...
        self.personality_traits = ['talkative', 'social', 'curious', 'enthusiastic', 'dramatic', 'well_informed']
        self.response_style = {'tone': 'excited_chatty', 'formality': 'very_casual', 'verbosity': 'very_verbose', 'humor': 'gossipy_fun'}
    ...
    def _get_fallback_response(self) -> str:
        ...
        return fallback_responses.get('Social', "I didn't understand that. Could you please rephrase?")
