"""
Gossipqueen AI REST API Routes
Production-ready HTTP endpoints for gossipqueen agent
"""
...
gossipqueen_api = Blueprint('gossipqueen_api', __name__, url_prefix='/api/gossipqueen')
...
@gossipqueen_api.route('/health', methods=['GET'])
def health_check():
...
@gossipqueen_api.route('/chat', methods=['POST'])
@rate_limit
...
@gossipqueen_api.route('/analytics', methods=['GET'])
def get_analytics():
