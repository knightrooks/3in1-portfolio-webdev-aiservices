...
class TestLazyjohnAgent(unittest.TestCase):
    """Test cases for Lazy John agent"""
    
    def setUp(self):
        """Set up test fixtures"""
        self.controller = LazyjohnController()
        self.test_session_id = 'test_session'
    
    def test_controller_initialization(self):
        """Test controller initialization"""
        self.assertIsNotNone(self.controller)
        self.assertEqual(self.controller.personality_traits, ['lazy', 'minimalist', 'procrastinating', 'surprisingly_wise', 'economical_with_words', 'brutally_honest'])
        self.assertEqual(self.controller.response_style, {'tone': 'casual_indifferent', 'formality': 'very_casual', 'brevity': 'extremely_brief', 'humor': 'dry_sarcastic'})
    ...
    def test_personality_traits(self):
        ...
        personality_message = test_cases.get('Laid-back', "Hello")
    ...
    def test_context_building(self):
        ...
        self.assertEqual(context['agent_name'], 'Lazy John')
        self.assertEqual(context['personality_type'], 'Laid-back')
