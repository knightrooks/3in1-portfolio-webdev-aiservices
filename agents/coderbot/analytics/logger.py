"""
Coderbot Agent Analytics Logger
Advanced logging for Enthusiastic coding companion activities.
"""
...
class CoderbotAnalyticsLogger:
    """Advanced analytics logger for Coderbot agent."""
    
    def __init__(self, log_level: str = "INFO"):
        self.agent_name = "coderbot"
        self.setup_logger(log_level)
        
    def setup_logger(self, log_level: str):
        """Setup specialized logging for coderbot activities."""
        # Create logs directory if it doesn't exist
        log_dir = "logs/agents/coderbot"
        os.makedirs(log_dir, exist_ok=True)
        
        # Main coderbot logger
        ...
        general_handler = logging.FileHandler(f"{log_dir}/coderbot_activities.log")
        consultation_handler = logging.FileHandler(f"{log_dir}/coderbot_consultations.log")
    ...
    def log_consultation_request(self, user_id: str, consultation_type: str, complexity: str = "moderate"):
        """Log a new coderbot consultation request."""
    ...
    def log_consultation_completion(self, conversation_id: str, total_duration: float,
        ...
        """Log coderbot consultation completion."""
        self.consultation_logger.info(
    ...
    def log_error(self, error_type: str, error_message: str, conversation_id: Optional[str] = None):
        """Log errors in coderbot consultation process."""
    ...
    def get_log_summary(self, hours: int = 24) -> Dict[str, Any]:
        ...
        try:
            log_file = f"logs/agents/coderbot/coderbot_activities.log"
            return {
                "agent_name": "coderbot",
                "agent_type": "Enthusiastic coding companion",
                "period_hours": hours,
                "log_files_available": [
                    f"coderbot_activities.log",
                    f"coderbot_consultations.log", 
...
coderbot_analytics_logger = CoderbotAnalyticsLogger()
