...
class CoderbotSocketHandler:
    """Production WebSocket handler for Coderbot agent"""
    ...
    def setup_handlers(self):
        ...
        @self.socketio.on("connect", namespace="/coderbot")
        def handle_connect():
        ...
        @self.socketio.on("disconnect", namespace="/coderbot")
        ...
        @self.socketio.on("message", namespace="/coderbot")
        ...
        @self.socketio.on("ping", namespace="/coderbot")
        def handle_ping():
