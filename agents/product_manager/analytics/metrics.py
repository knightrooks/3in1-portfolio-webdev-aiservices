...
class ProductManagerMetrics(PerformanceTracker):
    ...
    def __init__(self, agent_name: str = "product_manager"):
        ...
        self.specialized_metrics = {'feature_planning': 0, 'roadmap_creation': 0, 'stakeholder_management': 0, 'market_research': 0}
        
        self.conversation_types = {'product_planning': 0, 'feature_specification': 0, 'roadmap_review': 0, 'market_analysis': 0}
        
        self.deliverables = {'product_specs': 0, 'roadmaps': 0, 'feature_docs': 0, 'market_research': 0}
