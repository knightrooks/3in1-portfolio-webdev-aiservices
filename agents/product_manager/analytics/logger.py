"""
Product Manager Agent Analytics Logger
Advanced logging for Product strategy and roadmap planning activities.
"""
...
class ProductManagerAnalyticsLogger:
    """Advanced analytics logger for Product Manager agent."""
    ...
    def setup_logger(self, log_level: str):
        """Setup specialized logging for product manager activities."""
        # Create logs directory if it doesn't exist
        log_dir = "logs/agents/product_manager"
        os.makedirs(log_dir, exist_ok=True)
        
        # Main product_manager logger
        ...
        general_handler = logging.FileHandler(f"{log_dir}/product_manager_activities.log")
        consultation_handler = logging.FileHandler(f"{log_dir}/product_manager_consultations.log")
    ...
    def log_consultation_request(self, user_id: str, consultation_type: str, complexity: str = "moderate"):
        """Log a new product manager consultation request."""
    ...
    def log_consultation_completion(self, conversation_id: str, total_duration: float,
        ...
        """Log product manager consultation completion."""
        self.consultation_logger.info(
    ...
    def log_error(self, error_type: str, error_message: str, conversation_id: Optional[str] = None):
        """Log errors in product manager consultation process."""
    ...
    def get_log_summary(self, hours: int = 24) -> Dict[str, Any]:
        ...
        try:
            log_file = f"logs/agents/product_manager/product_manager_activities.log"
            return {
                "agent_name": "product_manager",
                "agent_type": "Product strategy and roadmap planning",
                "period_hours": hours,
                "log_files_available": [
                    f"product_manager_activities.log",
                    f"product_manager_consultations.log", 
...
product_manager_analytics_logger = ProductManagerAnalyticsLogger()
