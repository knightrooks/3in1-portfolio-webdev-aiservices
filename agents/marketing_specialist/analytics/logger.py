...
class MarketingSpecialistAnalyticsLogger:
    ...
    def setup_logger(self, log_level: str):
        ...
        general_handler = logging.FileHandler(
            f"{log_dir}/marketing_specialist_activities.log"
        )
        consultation_handler = logging.FileHandler(
            f"{log_dir}/marketing_specialist_consultations.log"
        )
    ...
    def get_log_summary(self, hours: int = 24) -> Dict[str, Any]:
        ...
        try:
            log_file = (
                f"logs/agents/marketing_specialist/marketing_specialist_activities.log"
            )
            return {
