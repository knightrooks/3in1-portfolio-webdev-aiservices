"""
Data Scientist AI Controller
Main orchestration controller for data_scientist agent
"""
...
from .planner import Data_ScientistPlanner
from .executor import Data_ScientistExecutor
...
class Data_ScientistController:
    """Main controller for Data Scientist AI"""

    def __init__(self):
        self.planner = Data_ScientistPlanner()
        self.executor = Data_ScientistExecutor()
        self.memory = EpisodicMemory("data_scientist")
        self.dispatcher = ModelDispatcher("data_scientist")
    ...
    def get_capabilities(self) -> List[str]:
        ...
        return [
            "Advanced data science specialist with mathematical modeling",
