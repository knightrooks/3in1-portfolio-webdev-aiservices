...
class ResearchAnalystAnalyticsLogger:
    ...
    def setup_logger(self, log_level: str):
        ...
        general_handler = logging.FileHandler(f"{log_dir}/research_analyst_activities.log")
        consultation_handler = logging.FileHandler(f"{log_dir}/research_analyst_consultations.log")
