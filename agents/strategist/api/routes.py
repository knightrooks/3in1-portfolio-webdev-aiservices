...
Production-ready HTTP endpoints for strategist agent
"""
...
strategist_api = Blueprint('strategist_api', __name__, url_prefix='/api/strategist')
...
@strategist_api.route('/chat', methods=['POST'])
@rate_limit
...
@strategist_api.route('/analytics', methods=['GET'])
def get_analytics():
    ...
    try:
        analytics_data = {
            ...
            'specialties': metrics.specialized_metrics,
            'conversation_types': metrics.conversation_types,
