...
ALL_AGENTS = {
    ...
    'strategist': {
        ...
        'capabilities': ['strategic_planning', 'business_analysis', 'market_research', 'competitive_analysis'],
        'icon': '📊',
        'color': '#2563eb'
    },
    'developer': {
        ...
        'category': 'professional',
        'capabilities': ['code_development', 'architecture_design', 'debugging', 'testing'],
        'icon': '💻',
        'color': '#059669'
    },
    'security_expert': {
        ...
        'category': 'professional',
        'capabilities': ['security_analysis', 'vulnerability_assessment', 'penetration_testing', 'compliance'],
        'icon': '🔐',
        'color': '#dc2626'
    },
    'content_creator': {
        ...
        'category': 'professional',
        'capabilities': ['content_strategy', 'copywriting', 'seo_optimization', 'social_media'],
        'icon': '✍️',
        'color': '#7c3aed'
    },
    'research_analyst': {
        ...
        'category': 'professional',
        'capabilities': ['market_research', 'data_analysis', 'trend_analysis', 'reporting'],
        'icon': '🔍',
        'color': '#ea580c'
    },
    'data_scientist': {
        ...
        'category': 'professional',
        'capabilities': ['data_analysis', 'machine_learning', 'statistical_modeling', 'predictive_analytics'],
        'icon': '📈',
        'color': '#0891b2'
    },
    'customer_success': {
    ...
    'product_manager': {
        ...
        'category': 'professional',
        'capabilities': ['product_strategy', 'roadmap_planning', 'feature_prioritization', 'user_research'],
        'icon': '📋',
        'color': '#9333ea'
    },
    'marketing_specialist': {
        ...
        'category': 'professional',
        'capabilities': ['marketing_strategy', 'campaign_management', 'brand_development', 'digital_marketing'],
        'icon': '📢',
        'color': '#e11d48'
    },
    'operations_manager': {
        ...
        'category': 'professional',
        'capabilities': ['process_optimization', 'resource_management', 'quality_assurance', 'workflow_design'],
        'icon': '⚙️',
        'color': '#6b7280'
    },
    ...
    'strictwife': {
        ...
        'category': 'entertainment',
        'capabilities': ['discipline', 'organization', 'accountability', 'structured_guidance'],
        'icon': '👩‍💼',
        'color': '#7c2d12'
    },
    'coderbot': {
...
def agents_dashboard():
    ...
    professional_agents = {k: v for k, v in ALL_AGENTS.items() if v['category'] == 'professional'}
    entertainment_agents = {k: v for k, v in ALL_AGENTS.items() if v['category'] == 'entertainment'}
...
def api_overview():
    ...
    return jsonify({
        ...
        'data': {
            'total_agents': len(ALL_AGENTS),
            'professional_count': len([a for a in ALL_AGENTS.values() if a['category'] == 'professional']),
            'entertainment_count': len([a for a in ALL_AGENTS.values() if a['category'] == 'entertainment']),
            'agents': agent_apis
        }
    })
...
def agents_health():
    ...
    return jsonify({
        'success': True,
        'data': {
            'overall_status': 'healthy' if healthy_count == total_count else 'partial',
...
def agents_analytics():
    ...
    analytics_data = {
        'total_agents': len(ALL_AGENTS),
        'categories': {
            'professional': len([a for a in ALL_AGENTS.values() if a['category'] == 'professional']),
            'entertainment': len([a for a in ALL_AGENTS.values() if a['category'] == 'entertainment'])
        },
        'capabilities': {},
        'agents': {}
    }
...
def register_agent_websockets(socketio):
    ...
    for agent_id in ALL_AGENTS.keys():
        try:
            agent_socket_module = importlib.import_module(f'agents.{agent_id}.api.socket')
            if hasattr(agent_socket_module, f'{agent_id.replace("_", "").title()}SocketHandler'):
                handler_class = getattr(agent_socket_module, f'{agent_id.replace("_", "").title()}SocketHandler')
