    ...
    return jsonify(
        {
            ...
            "uptime": (
                time.time() - analytics_bp.start_time
                if hasattr(analytics_bp, "start_time")
                else 0
            ),
        }
    )
    ...
    return jsonify(
        {
            ...
            "performance": {"avg_response_time": "2.3s", "uptime": "99.7%"},
        }
    )
    ...
    return jsonify(
        {
            ...
            "revenue": {"monthly": 15420, "quarterly": 48650, "growth_rate": 23.5},
        }
    )
