...
def load_agent_registry():
    ...
    try:
        registry_path = os.path.join(os.path.dirname(__file__), '..', 'ai', 'registry.yaml')
...
def index():
    ...
    return render_template('ai_services/index.html', 
...
def showcase():
    ...
    return render_template('ai_services/showcase.html', 
                         models=model_showcase)
...
def agent_profile(agent_id):
    ...
    for other_id, other_data in agents.items():
        if other_id != agent_id:
            ...
            if (other_data.get('personality_type') == agent_personality or 
                len(agent_capabilities.intersection(other_capabilities)) >= 2):
    ...
    return render_template('ai_services/agent_profile.html', 
...
def chat(agent_id=None):
    ...
    if not agent_id:
        ...
        return render_template('ai_services/chat.html', 
...
def pricing():
    ...
    return render_template('ai_services/pricing.html', 
