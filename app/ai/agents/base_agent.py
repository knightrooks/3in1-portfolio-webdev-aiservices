...
class BaseAgent(ABC):
    ...
    async def select_model(self, task_type: str) -> str:
        ...
        return self.model_ensemble.get(model_role, self.model_ensemble.get('primary_model'))
    
    async def execute_with_model(self, model_name: str, prompt: str, context: Dict = None) -> Dict[str, Any]:
    ...
    async def collaborate_with_agent(self, other_agent: str, request: Dict[str, Any]) -> Dict[str, Any]:
