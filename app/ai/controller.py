...
class AIController:
    ...
    async def create_session(
        self, agent_type: str, user_id: str = None, context: Dict = None
    ) -> str:
    ...
    async def process_message(
        self, session_id: str, message: str, attachments: List = None
    ) -> Dict:
        ...
        response = await self.executor.execute_plan(
            plan=task_plan, models=self.models, session_context=session
        )
